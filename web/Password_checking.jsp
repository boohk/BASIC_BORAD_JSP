...
<div class="container" style="align-content:center; text-align: center; margin-top: 200px;  ">
    <form action="Password_confirm.jsp" method="post" accept-charset="utf-8" name="password_checking"
          id="password_checking">
        ...
        <ul class="list-group">
            ...
            <li class="list-group-item">
                <input type="submit" class="btn btn-primary" alt="확인" value="확인" style="cursor:pointer;"/>
